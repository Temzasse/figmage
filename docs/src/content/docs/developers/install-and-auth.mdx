...
<Aside>
  ...
  REST API. See the designer guide on [publishing a library](/designers/publish-and-share/) for
  details.
</Aside>
...
For a complete automation workflow, see [CI](/developers/ci/).
